...
var require_algoliasearch_umd = __commonJS({
  "node_modules/algoliasearch/dist/algoliasearch.umd.js"(exports, module) {
    !function(t, e) {
      ...
      var g = { Read: 1, Write: 2, Any: 3 }, v = 1, b = 2, O = 3;
      function P(t2) {
      ...
      function q(t2, e2) {
        return Promise.all(e2.map(function(e3) {
          ...
          var r2 = t3.filter(function(t4) {
            ...
            return function(t5) {
              return t5.status === O && Date.now() - t5.lastUpdate <= 12e4;
            }(t4);
          }), a2 = [].concat(o(r2), o(n2));
      ...
      function S(t2, e2, n2, a2) {
        var i2 = [], u2 = function(t3, e3) {
          if (t3.method === j || void 0 === t3.data && void 0 === e3.data)
            return;
        ...
        }(t2, a2), c2 = n2.method, f2 = n2.method !== j ? {} : r(r({}, n2.data), a2.data), d2 = r(r(r({ "x-algolia-agent": t2.userAgent.value }, t2.queryParameters), f2), a2.queryParameters), l2 = 0, p2 = function e3(r2, o2) {
          var f3 = r2.pop();
          if (void 0 === f3)
          ...
          var p3 = { data: u2, headers: s2, method: c2, url: N(f3, n2.path, d2), connectTimeout: o2(l2, t2.timeouts.connect), responseTimeout: o2(l2, a2.timeout) }, h2 = function(t3) {
            ...
            var a3 = h2(n3);
            return n3.isTimedOut && l2++, Promise.all([t2.logger.info("Retryable failure", A(a3)), t2.hostsCache.set(f3, P(f3, n3.isTimedOut ? O : b))]).then(function() {
              return e3(r2, o2);
            });
          }, onFail: function(t3) {
      ...
      var C = function(t2) {
        return function(e2, r2) {
          return t2.transporter.write({ method: x, path: "2/abtests", data: e2 }, r2);
        };
      }, U = function(t2) {
        return function(e2, r2) {
        ...
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: h("2/abtests/%s", e2) }, r2);
        };
      }, J = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: "2/abtests" }, e2);
        };
      }, F = function(t2) {
        return function(e2, r2) {
          return t2.transporter.write({ method: x, path: h("2/abtests/%s/stop", e2) }, r2);
        };
      }, H = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: "1/strategies/personalization" }, e2);
        };
      }, M = function(t2) {
        return function(e2, r2) {
          return t2.transporter.write({ method: x, path: "1/strategies/personalization", data: e2 }, r2);
        };
      };
      function K(t2) {
        return function e2(r2) {
      ...
      var W = function(t2) {
        return function(e2, a2) {
          ...
          return d(t2.transporter.write({ method: x, path: "1/keys", data: s2 }, u2), function(e3, r2) {
        ...
        return function(e2, r2, n2) {
          var a2 = y(n2);
          return a2.queryParameters["X-Algolia-User-ID"] = e2, t2.transporter.write({ method: x, path: "1/clusters/mapping", data: { cluster: r2 } }, a2);
        };
      }, Q = function(t2) {
        return function(e2, r2, n2) {
          return t2.transporter.write({ method: x, path: "1/clusters/mapping/batch", data: { users: e2, cluster: r2 } }, n2);
        };
      }, G = function(t2) {
        return function(e2, r2) {
          return d(t2.transporter.write({ method: x, path: h("/1/dictionaries/%s/batch", e2), data: { clearExistingDictionaryEntries: true, requests: { action: "addEntry", body: [] } } }, r2), function(e3, r3) {
            return xt(t2)(e3.taskID, r3);
          });
        };
      }, L = function(t2) {
        return function(e2, r2, n2) {
          return d(t2.transporter.write({ method: x, path: h("1/indexes/%s/operation", e2), data: { operation: "copy", destination: r2 } }, n2), function(r3, n3) {
        ...
        return function(e2, r2) {
          return e2.method === j ? t2.transporter.read(e2, r2) : t2.transporter.write(e2, r2);
        };
      }, Z = function(t2) {
        return function(e2, r2) {
        ...
        return function(e2, r2, n2) {
          ...
          return d(t2.transporter.write({ method: x, path: h("/1/dictionaries/%s/batch", e2), data: { clearExistingDictionaryEntries: false, requests: a2 } }, n2), function(e3, r3) {
            return xt(t2)(e3.taskID, r3);
          });
        };
      }, tt = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: h("1/keys/%s", e2) }, r2);
        };
      }, et = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: h("1/task/%s", e2.toString()) }, r2);
        };
      }, rt = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: "/1/dictionaries/*/settings" }, e2);
        };
      }, nt = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: "1/logs" }, e2);
        };
      }, at = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: "1/clusters/mapping/top" }, e2);
        };
      }, ot = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: h("1/clusters/mapping/%s", e2) }, r2);
        };
      }, it = function(t2) {
        return function(e2) {
          var r2 = e2 || {}, a2 = r2.retrieveMappings, o2 = n(r2, ["retrieveMappings"]);
          return true === a2 && (o2.getClusters = true), t2.transporter.read({ method: j, path: "1/clusters/mapping/pending" }, o2);
        };
      }, ut = function(t2) {
        return function(e2) {
        ...
        return function(e2) {
          return t2.transporter.read({ method: j, path: "1/keys" }, e2);
        };
      }, ct = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: "1/clusters" }, e2);
        };
      }, ft = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: "1/indexes" }, e2);
        };
      }, dt = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: "1/clusters/mapping" }, e2);
        };
      }, lt = function(t2) {
        return function(e2, r2, n2) {
          return d(t2.transporter.write({ method: x, path: h("1/indexes/%s/operation", e2), data: { operation: "move", destination: r2 } }, n2), function(r3, n3) {
            return ut(t2)(e2, { methods: { waitTask: de } }).waitTask(r3.taskID, n3);
          });
        };
      }, pt = function(t2) {
        return function(e2, r2) {
          return d(t2.transporter.write({ method: x, path: "1/indexes/*/batch", data: { requests: e2 } }, r2), function(e3, r3) {
        ...
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: "1/indexes/*/objects", data: { requests: e2 } }, r2);
        };
      }, mt = function(t2) {
        return function(e2, n2) {
          ...
          return t2.transporter.read({ method: x, path: "1/indexes/*/queries", data: { requests: a2 }, cacheable: true }, n2);
        };
      }, yt = function(t2) {
        return function(e2, a2) {
          return Promise.all(e2.map(function(e3) {
        ...
        return function(e2, r2, n2) {
          ...
          return d(t2.transporter.write({ method: x, path: h("/1/dictionaries/%s/batch", e2), data: { clearExistingDictionaryEntries: true, requests: a2 } }, n2), function(e3, r3) {
            return xt(t2)(e3.taskID, r3);
          });
        };
      }, bt = function(t2) {
        return function(e2, r2) {
          return d(t2.transporter.write({ method: x, path: h("1/keys/%s/restore", e2) }, r2), function(r3, n2) {
            return f(function(r4) {
        ...
        return function(e2, r2, n2) {
          return t2.transporter.read({ method: x, path: h("/1/dictionaries/%s/search", e2), data: { query: r2 }, cacheable: true }, n2);
        };
      }, wt = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: "1/clusters/mapping/search", data: { query: e2 } }, r2);
        };
      }, It = function(t2) {
        return function(e2, r2) {
        ...
        return function(e2, r2) {
          return d(t2.transporter.write({ method: x, path: h("1/indexes/%s/batch", t2.indexName), data: { requests: e2 } }, r2), function(e3, r3) {
        ...
        return function(e2) {
          return K(r(r({ shouldStop: function(t3) {
            ...
            return t2.transporter.read({ method: x, path: h("1/indexes/%s/browse", t2.indexName), data: r2 }, e2);
          } }));
        };
      }, St = function(t2) {
        return function(e2) {
        ...
        return function(e2) {
          return d(t2.transporter.write({ method: x, path: h("1/indexes/%s/clear", t2.indexName) }, e2), function(e3, r2) {
        ...
        return function(e2) {
          ...
          return a2 && (o2.queryParameters.forwardToReplicas = 1), d(t2.transporter.write({ method: x, path: h("1/indexes/%s/rules/clear", t2.indexName) }, o2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, Rt = function(t2) {
        return function(e2) {
          var r2 = e2 || {}, a2 = r2.forwardToReplicas, o2 = y(n(r2, ["forwardToReplicas"]));
          return a2 && (o2.queryParameters.forwardToReplicas = 1), d(t2.transporter.write({ method: x, path: h("1/indexes/%s/synonyms/clear", t2.indexName) }, o2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, At = function(t2) {
        return function(e2, r2) {
          return d(t2.transporter.write({ method: x, path: h("1/indexes/%s/deleteByQuery", t2.indexName), data: e2 }, r2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, Ct = function(t2) {
        ...
        return function(e2, r2, n2) {
          return t2.transporter.read({ method: x, path: h("1/answers/%s/prediction", t2.indexName), data: { query: e2, queryLanguages: r2 }, cacheable: true }, n2);
        };
      }, Kt = function(t2) {
        ...
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: h("1/indexes/%s/%s", t2.indexName, e2) }, r2);
        };
      }, Bt = function() {
        ...
        return function(e2, a2) {
          ...
          return t2.transporter.read({ method: x, path: "1/indexes/*/objects", data: { requests: s2 } }, u2);
        };
      }, Gt = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: h("1/indexes/%s/rules/%s", t2.indexName, e2) }, r2);
        };
      }, Lt = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: j, path: h("1/indexes/%s/settings", t2.indexName), data: { getVersion: 2 } }, e2);
        };
      }, Vt = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: h("1/indexes/%s/synonyms/%s", t2.indexName, e2) }, r2);
        };
      }, _t = function(t2) {
        return function(e2, r2) {
        ...
        return function(e2, i2) {
          var u2 = i2 || {}, s2 = u2.safe, c2 = u2.autoGenerateObjectIDIfNotExist, f2 = u2.batchSize, l2 = n(u2, ["safe", "autoGenerateObjectIDIfNotExist", "batchSize"]), p2 = function(e3, r2, n2, a2) {
            return d(t2.transporter.write({ method: x, path: h("1/indexes/%s/operation", e3), data: { operation: n2, destination: r2 } }, a2), function(e4, r3) {
        ...
        return function(e2, r2) {
          ...
          return o2 && (u2.queryParameters.forwardToReplicas = 1), i2 && (u2.queryParameters.clearExistingRules = 1), d(t2.transporter.write({ method: x, path: h("1/indexes/%s/rules/batch", t2.indexName), data: e2 }, u2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, ae = function(t2) {
        ...
        return function(e2, r2) {
          ...
          return o2 && (s2.queryParameters.forwardToReplicas = 1), (u2 || i2) && (s2.queryParameters.replaceExistingSynonyms = 1), d(t2.transporter.write({ method: x, path: h("1/indexes/%s/synonyms/batch", t2.indexName), data: e2 }, s2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, ie = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: h("1/indexes/%s/query", t2.indexName), data: { query: e2 }, cacheable: true }, r2);
        };
      }, ue = function(t2) {
        return function(e2, r2, n2) {
          return t2.transporter.read({ method: x, path: h("1/indexes/%s/facets/%s/query", t2.indexName, e2), data: { facetQuery: r2 }, cacheable: true }, n2);
        };
      }, se = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: h("1/indexes/%s/rules/search", t2.indexName), data: { query: e2 } }, r2);
        };
      }, ce = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: h("1/indexes/%s/synonyms/search", t2.indexName), data: { query: e2 } }, r2);
        };
      }, fe = function(t2) {
        return function(e2, r2) {
          var a2 = r2 || {}, o2 = a2.forwardToReplicas, i2 = y(n(a2, ["forwardToReplicas"]));
          ...
          return f(function(n2) {
            return (/* @__PURE__ */ function(t3) {
              return function(e3, r3) {
                return t3.transporter.read({ method: j, path: h("1/indexes/%s/task/%s", t3.indexName, e3.toString()) }, r3);
              };
      ...
      function ge(t2, e2, n2) {
        ...
        } }), responsesCache: s(), requestsCache: s({ serializable: false }), hostsCache: u({ caches: [i({ key: "".concat("4.22.1", "-").concat(t2) }), s()] }), userAgent: T("4.22.1").add({ segment: "Browser" }) }, f2 = r(r({}, o2), n2), d2 = function() {
          return function(t3) {
            return function(t4) {
